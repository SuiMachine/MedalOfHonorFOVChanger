namespace FovChanger
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.InputPanel.Controls.Add(this.L_FOVMultiplierValue);
			this.InputPanel.Controls.Add(this.label3);
			this.InputPanel.Controls.Add(this.TBar_Multiplier);
		...
		private System.Windows.Forms.TrackBar TBar_Multiplier;
	}
}
